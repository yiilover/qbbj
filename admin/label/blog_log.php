...
if($action=='mod'){
	...
	if($inc=="blog_log")
	{
		$_url='$webdb[www_url]/'.$ModuleDB[blog_]['dirname'].'/index.php?file=viewlog&uid=$uid&id=$id';
		$_listurl='$webdb[www_url]/'.$ModuleDB[blog_]['dirname'].'/log.php?fid=$fid';
	}
	elseif($inc=="blog_photo")
	{
		$_url='$webdb[www_url]/'.$ModuleDB[blog_]['dirname'].'/index.php?file=viewphoto&uid=$uid&id=$id';
		$_listurl='$webdb[www_url]/'.$ModuleDB[blog_]['dirname'].'/photo.php?fid=$fid';
	}
