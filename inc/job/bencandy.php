...
if($act=="do"){
	...
	else
	{
		...
		if($type!='show'){
			echo "<a href='$webdb[www_url]$webdb[path]/bencandy.php?fid=$fid&id=$id&jobs=show'>标签设置</a>";
		}else{
			echo "<a href='$webdb[www_url]$webdb[path]/bencandy.php?fid=$fid&id=$id&'>退出标签设置</a>";
		}
