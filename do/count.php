...
document.write(\"<SCRIPT LANGUAGE='JavaScript' src='$thispath/count/count.php?fid=$_GET[fid]&nowurl=\"+stats_href+\"&fromurl=\"+stats_referrer+\"&windows_lang=\"+stats_language+\"&screen_size=\"+stats_screensize+\"'></SCRIPT>\");
	";
?>